...
public class IMG extends Applets {
	...
	{
		pic=getImage(getDocumentBase(), "com/java/GUI/Applet/nature.jpg");//public Image getImage(URL url, String name) // name: the location of the image, relative to the url argument.
	}
	
	public void paint(Graphics g) {
		//public abstract boolean drawImage(Image img, int x, int y, ImageObserver observer);
		g.drawImage(pic, 5, 5, this);
		/*for (int i=0;i<=500;i++) {
